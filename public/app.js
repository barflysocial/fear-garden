  ...
  app.innerHTML = html`
    <section class="hero">
      <div class="title-card">
        ...
        <p class="tagline">Create the episode, share the player link, and control the game.</p>
        ${renderHowToPlayInstructions('host')}
        <div class="panel soft">
          <h2>Create a Game</h2>
          <p>Pick an episode and create a live session for up to 6 players.</p>
          ...
          <p class="muted small">Use the saved browser session, or enter the Game Code and Host Recovery Key from the host dashboard.</p>
          ...
          <a class="btn" href="/play">Open Player Screen</a>
        </div>
        <div class="divider"></div>
