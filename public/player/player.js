...
function enqueueClueDialogs(clues, sessionCode) {
  // Clue content intentionally does not appear in popups.
  // Players review newly unlocked evidence inside the investigation apps.
  for (const clue of clues) {
    if (clue?.id) rememberAck('clue', clue.id);
  }
}
